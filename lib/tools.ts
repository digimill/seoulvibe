...
const TOOL_COPY: Record<Lang, Record<ToolId, ToolCopy>> = {
  en: {
    ...
    "right-now": { title: "Right Now Helper", desc: "One immediate recommendation in seconds." },
  },
  ko: {
    ...
    "right-now": { title: "Right Now Helper", desc: "지금 필요한 행동 1개를 바로 제안." },
  },
  ja: {
    ...
    "right-now": { title: "Right Now Helper", desc: "今すぐやる行動を1つ提示。" },
  },
  "zh-cn": {
    ...
    "right-now": { title: "Right Now Helper", desc: "几秒内给你一个立即动作。" },
  },
  "zh-tw": {
    ...
    "right-now": { title: "Right Now Helper", desc: "幾秒內給你一個立即行動。" },
  },
  "zh-hk": {
    ...
    "right-now": { title: "Right Now Helper", desc: "幾秒內畀你一個即時動作。" },
  },
};
