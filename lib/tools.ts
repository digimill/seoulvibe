...
export const TOOL_IDS = ["real-cost", "tmoney-load", "olive-budget", "kiosk-practice"] as const;
...
const TOOL_COPY: Record<Lang, Record<ToolId, ToolCopy>> = {
  en: {
    ...
    "kiosk-practice": { title: "Kiosk Practice", desc: "Interactive coffee and restaurant kiosk simulation." },
  },
  ko: {
    ...
    "kiosk-practice": { title: "키오스크 체험", desc: "커피/식당 체인 공통 흐름을 인터랙티브로 연습." },
  },
  ja: {
    ...
    "kiosk-practice": { title: "Kiosk Practice", desc: "コーヒー/飲食チェーンの共通フローを練習。" },
  },
  "zh-cn": {
    ...
    "kiosk-practice": { title: "Kiosk Practice", desc: "练习咖啡/餐饮连锁常见自助机流程。" },
  },
  "zh-tw": {
    ...
    "kiosk-practice": { title: "Kiosk Practice", desc: "練習咖啡/餐飲連鎖常見自助機流程。" },
  },
  "zh-hk": {
