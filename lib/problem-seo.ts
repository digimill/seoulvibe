...
const localizedQuestions: Record<string, Record<Exclude<Lang, "en">, string>> = {
  ...
  "do-korean-cafes-accept-foreign-credit-cards": {
    ...
    ja: "韓国でレートが良い両替先はどこ？",
    "zh-cn": "在韩国哪里换汇更划算？（手续费/汇率）",
    "zh-tw": "在韓國哪裡換匯比較划算？（手續費/匯率）",
    "zh-hk": "喺韓國邊度換錢會更抵？（手續費/匯率）",
  },
  ...
  "is-line-2-confusing-for-tourists": {
    ...
    ja: "路線図を見込まずに乗換と出口を見つけるには？",
    "zh-cn": "不看完整线路图，怎么快速找换乘和出口？",
    "zh-tw": "不看完整路線圖，怎麼快速找轉乘和出口？",
    "zh-hk": "唔睇完整路線圖，點樣快啲搵轉乘同出口？",
  },
  ...
  "is-gangnam-crowded-at-night": {
    ...
    ja: "韓国でeSIM/SIMの通信が不調な時、最初に何を確認する？",
    "zh-cn": "在韩国 eSIM/SIM 没网时，第一步该检查什么？",
    "zh-tw": "在韓國 eSIM/SIM 沒網時，第一步該檢查什麼？",
    "zh-hk": "喺韓國 eSIM/SIM 冇網時，第一步應該檢查咩？",
  },
  ...
  "best-olive-young-products-for-first-time-visitors": {
    ...
    ja: "韓国で体調不良やけがの時、病院・薬局はどう使う？",
    "zh-cn": "在韩国生病或受伤时，医院/药店该怎么用？",
    "zh-tw": "在韓國生病或受傷時，醫院/藥局該怎麼用？",
    "zh-hk": "喺韓國病咗或受傷時，醫院/藥房點樣用？",
  },
  "what-should-i-buy-at-olive-young-under-50": {
    ko: "오프라인 지도·번역 없이 길 찾으려면 어떻게 하나요?",
    ja: "オフライン地図や翻訳なしで道に迷わないには？",
    "zh-cn": "没有离线地图和翻译，怎么在首尔找路？",
    "zh-tw": "沒有離線地圖和翻譯，怎麼在首爾找路？",
    "zh-hk": "冇離線地圖同翻譯，點樣喺首爾搵路？",
  },
  "can-tourists-get-tax-refund-at-olive-young": {
    ko: "여권·지갑·휴대폰 분실 시 가장 먼저 뭘 해야 하나요?",
    ja: "韓国でパスポート・財布・スマホを失くしたら最初に何をする？",
    "zh-cn": "在韩国丢了护照/钱包/手机，第一步该做什么？",
    "zh-tw": "在韓國遺失護照/錢包/手機，第一步該做什麼？",
    "zh-hk": "喺韓國唔見咗護照/銀包/手機，第一步要做咩？",
  },
  ...
  "is-taxi-from-airport-expensive-in-seoul": {
    ...
    ja: "空港鉄道・空港バス・タクシーはどう選ぶべき？",
    "zh-cn": "机场快线、机场大巴、出租车该怎么选？",
    "zh-tw": "機場快線、機場巴士、計程車該怎麼選？",
    "zh-hk": "機場快線、機場巴士、的士應該點揀？",
  },
};
